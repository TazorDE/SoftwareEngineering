            ...
            if (products.length > 0) {
                ...
                products.forEach((product) => {
                    ...
                    temp +=
                        ...
                        '</svg></td>';
                    temp +=
                        '<td><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="darkred" class="bi bi-trash-fill" viewBox="0 0 16 16">' +
...
<main>
    <div class="title-line">
        ...
        <div class="search-bar">
            ...
            <input type="search" class="round-search" name="searchText" placeholder="Produkt suchen...">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" stroke-width="3" fill="currentColor" class="bi bi-search"
                 viewBox="0 0 16 16">
